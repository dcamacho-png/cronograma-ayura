...
INSERT INTO "new_Actividad" ("anio", "areaId", "areaTareaId", "descripcion", "dia", "estado", "fincaId", "hectareas", "horas", "id", "maquinaId", "motivoId", "nota", "origenId", "planB", "responsableId", "semana", "turno", "vecesReprogramada") SELECT "anio", "areaId", "areaTareaId", "descripcion", "dia", "estado", "fincaId", "hectareas", "horas", "id", "maquinaId", "motivoId", "nota", "origenId", "planB", "responsableId", "semana", "turno", "vecesReprogramada" FROM "Actividad";
