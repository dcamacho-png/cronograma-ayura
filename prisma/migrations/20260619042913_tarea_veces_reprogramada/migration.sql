...
CREATE TABLE "new_Tarea" (
    ...
    CONSTRAINT "Tarea_solicitadaPorAreaId_fkey" FOREIGN KEY ("solicitadaPorAreaId") REFERENCES "Area" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Tarea" ("anioSel", "areaId", "descripcion", "estado", "fincaId", "id", "loteId", "semanaSel", "solicitadaPorAreaId", "turno") SELECT "anioSel", "areaId", "descripcion", "estado", "fincaId", "id", "loteId", "semanaSel", "solicitadaPorAreaId", "turno" FROM "Tarea";
DROP TABLE "Tarea";
